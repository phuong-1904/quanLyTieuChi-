...
urlpatterns = [
    ...
    path('duyetYeuCauTienDo/', views.duyet_yeu_cau_tien_do_view, name='duyetYeuCauTienDo'),
    path('pheDuyetYeuCauTienDo/<int:event_id>/', views.phe_duyet_yeu_cau_tien_do_view, name='pheDuyetYeuCauTienDo'),
    path('khongDuyetYeuCauTienDo/<int:event_id>/', views.khong_duyet_yeu_cau_tien_do_view, name='khongDuyetYeuCauTienDo'),
    ...
    path('capNhatTienDoSuKien/<int:event_id>/', views.cap_nhat_tien_do_su_kien_view, name='capNhatTienDoSuKien'),
    path('capNhatLyDoTienDoSuKien/<int:event_id>/', views.cap_nhat_ly_do_tien_do_su_kien_view, name='capNhatLyDoTienDoSuKien'),
    ...
    path('user/duyetYeuCauTienDo/', views.user_duyet_yeu_cau_tien_do_view, name='user_duyetYeuCauTienDo'),
